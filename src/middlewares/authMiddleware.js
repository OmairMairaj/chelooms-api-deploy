...
// ==========================================
// 4. OPTIONAL AUTH (For Social/Gallery Flow)
// ==========================================
const optionalAuth = async (req, res, next) => {
    ...
    // Guest ho ya Logged in, donon ko API hit karne do
    next(); 
};
  
// Export sab ko kar do
module.exports = { protect, authorize, identifyUserOrGuest, optionalAuth };
